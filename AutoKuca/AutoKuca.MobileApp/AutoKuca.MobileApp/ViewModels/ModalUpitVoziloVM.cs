...
{
    public class ModalUpitVoziloVM : BaseViewModel
    {

        private ApiService _upit = new ApiService("UpitiVozila");

        string _imeprezime = string.Empty;
        string _email = string.Empty;
        string _poruka = string.Empty;
        ModalUpitVoziloPage page;
        public string Sifra;
        public int? ID;
        ...
        public ModalUpitVoziloVM(string sifra = null, int? id = null)
        {
            Title = "Upit";
            Sifra = sifra;
            ID = id;
